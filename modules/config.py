...
def try_load_deprecated_user_path_config():
    ...
    try:
        ...
        replace_config('CensuradoIA_expansion_path', 'path_CensuradoIA_expansion')
...
path_CensuradoIA_expansion = get_dir_or_set_default('path_CensuradoIA_expansion', '../models/prompt_expansion/CensuradoIA_expansion')
...
default_temp_path = os.path.join(tempfile.gettempdir(), 'CensuradoIA')
...
def get_model_filenames(folder_paths, extensions=None, name_filter=None):
    if extensions is None:
        extensions = ['.pth', '.ckpt', '.bin', '.safetensors', '.CensuradoIA.patch']
    files = []
...
def downloading_inpaint_models(v):
    ...
    load_file_from_url(
        url='https://huggingface.co/lllyasviel/CensuradoIA_inpaint/resolve/main/CensuradoIA_inpaint_head.pth',
        model_dir=path_inpaint,
        file_name='CensuradoIA_inpaint_head.pth'
    )
    head_file = os.path.join(path_inpaint, 'CensuradoIA_inpaint_head.pth')
    patch_file = None

    if v == 'v1':
        load_file_from_url(
            url='https://huggingface.co/lllyasviel/CensuradoIA_inpaint/resolve/main/inpaint.CensuradoIA.patch',
            model_dir=path_inpaint,
            file_name='inpaint.CensuradoIA.patch'
        )
        patch_file = os.path.join(path_inpaint, 'inpaint.CensuradoIA.patch')

    if v == 'v2.5':
        load_file_from_url(
            url='https://huggingface.co/lllyasviel/CensuradoIA_inpaint/resolve/main/inpaint_v25.CensuradoIA.patch',
            model_dir=path_inpaint,
            file_name='inpaint_v25.CensuradoIA.patch'
        )
        patch_file = os.path.join(path_inpaint, 'inpaint_v25.CensuradoIA.patch')

    if v == 'v2.6':
        load_file_from_url(
            url='https://huggingface.co/lllyasviel/CensuradoIA_inpaint/resolve/main/inpaint_v26.CensuradoIA.patch',
            model_dir=path_inpaint,
            file_name='inpaint_v26.CensuradoIA.patch'
        )
        patch_file = os.path.join(path_inpaint, 'inpaint_v26.CensuradoIA.patch')
...
def downloading_controlnet_cpds():
    load_file_from_url(
        url='https://huggingface.co/lllyasviel/misc/resolve/main/CensuradoIA_xl_cpds_128.safetensors',
        model_dir=path_controlnet,
        file_name='CensuradoIA_xl_cpds_128.safetensors'
    )
    return os.path.join(path_controlnet, 'CensuradoIA_xl_cpds_128.safetensors')
...
def downloading_ip_adapters(v):
    ...
    load_file_from_url(
        url='https://huggingface.co/lllyasviel/misc/resolve/main/CensuradoIA_ip_negative.safetensors',
        model_dir=path_controlnet,
        file_name='CensuradoIA_ip_negative.safetensors'
    )
    results += [os.path.join(path_controlnet, 'CensuradoIA_ip_negative.safetensors')]
...
def downloading_upscale_model():
    load_file_from_url(
        url='https://huggingface.co/lllyasviel/misc/resolve/main/CensuradoIA_upscaler_s409985e5.bin',
        model_dir=path_upscale_models,
        file_name='CensuradoIA_upscaler_s409985e5.bin'
    )
    return os.path.join(path_upscale_models, 'CensuradoIA_upscaler_s409985e5.bin')
